...
export function InsightCard({
  ...
  return (
    <div className={cn("insight-card p-3 sm:p-4", config.border, className)}>
      <div
        className={cn(
      ...
      <div className="flex-1 min-w-0">
        {title && <h4 className="text-xs sm:text-sm font-medium text-white mb-1">{title}</h4>}
        <p className="text-xs sm:text-sm text-gray-300 leading-relaxed">{message}</p>
      </div>
    </div>
  );
}
